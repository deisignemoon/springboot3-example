...
public class Main__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.scheduling.annotation.ProxyAsyncConfiguration", "com.xiacong.common.thread.ExecutorConfig");
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.xiacong.config.SecurityConfiguration");
    mappings.put("org.springframework.security.config.annotation.method.configuration.GlobalMethodSecurityConfiguration", "com.xiacong.config.SecurityConfiguration");
