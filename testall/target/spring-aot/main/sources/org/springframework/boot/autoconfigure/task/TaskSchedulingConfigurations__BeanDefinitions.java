...
public class TaskSchedulingConfigurations__BeanDefinitions {
  ...
  public static class TaskSchedulerConfiguration {
     ...
     */
    private static BeanInstanceSupplier<SimpleAsyncTaskScheduler> getTaskSchedulerInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<SimpleAsyncTaskScheduler>forFactoryMethod(TaskSchedulingConfigurations.TaskSchedulerConfiguration.class, "taskSchedulerVirtualThreads", SimpleAsyncTaskSchedulerBuilder.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(TaskSchedulingConfigurations.TaskSchedulerConfiguration.class).taskSchedulerVirtualThreads(args.get(0)));
    }
    ...
    public static BeanDefinition getTaskSchedulerBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(SimpleAsyncTaskScheduler.class);
